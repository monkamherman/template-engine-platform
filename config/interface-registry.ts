...
export const interfaceRegistry = [
  ...
  })),
  {
    ...
    maturity: "BRANDED",
    dataMode: "content",
    notes: "Sprint 06E-bis branded FAQ page with categorized accordions, licensing boundary explanation and CTA paths to pricing and documentation.",
  },
  {
    ...
    maturity: "BRANDED",
    dataMode: "preview",
    notes: "Sprint 06E-bis branded contact page with request-channel cards, disabled preview form, safe-message warning and links to FAQ, pricing and documentation.",
  },
  {
    id: "marketing.about",
    title: "About",
    routePattern: p("/about"),
    buildPath: routes.marketing.about,
    audience: "public",
    owner: "marketing/product",
    maturity: "BRANDED",
    dataMode: "content",
    notes: "Sprint 06E-bis branded about page explaining vision, problem, solution, operating philosophy, build scope and explicit non-promises.",
  },
  ...legalSlugs.map((slug) => ({
    id: `legal.${slug}`,
